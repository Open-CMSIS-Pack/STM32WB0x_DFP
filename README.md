[![Version](https://img.shields.io/github/v/release/Open-CMSIS-Pack/STM32WB0x_DFP)](https://github.com/Open-CMSIS-Pack/STM32WB0x_DFP/releases/latest)

# STM32WB0x_DFP

This is the development repository for the **STMicroelectronics STM32WB0 Series Device Family Pack (DFP)** - a CMSIS software pack that is designed to work with all compiler toolchains (Arm Compiler, GCC, IAR, LLVM). It is released as [CMSIS software pack](https://www.keil.arm.com/packs/stm32c0xx_dfp-keil) and therefore accessible by CMSIS-Pack enabled software development tools.
...
:---------------------------|:--------------
[.github/workflows](https://github.com/Open-CMSIS-Pack/STM32WB0x_DFP/tree/main/.github/workflows)  | [GitHub Actions](#github-actions) for creating the software pack.
[CMSIS/Flash](https://github.com/Open-CMSIS-Pack/STM32WB0x_DFP/tree/main/CMSIS/Flash)              | Contains flash algorithms.
[CMSIS/SVD](https://github.com/Open-CMSIS-Pack/STM32WB0x_DFP/tree/main/CMSIS/SVD)                  | Contains SVD files for the devices.
[Templates](https://github.com/Open-CMSIS-Pack/STM32WB0x_DFP/tree/main/Templates)                  | Device specific project templates to start new *csolution projects*.
...
This development repository can be used in a local directory and [mapped as software pack](https://github.com/Open-CMSIS-Pack/cmsis-toolbox/blob/main/docs/build-tools.md#install-a-repository) using for example `cpackget` with:
    ...
    cpackget add <path>/Keil.STM32WB0x_DFP.pdsc
...
The DFP is licensed under [![License](https://img.shields.io/github/license/Open-CMSIS-Pack/STM32WB0x_DFP?label)](https://github.com/Open-CMSIS-Pack/STM32WB0x_DFP/blob/main/LICENSE).

## Issues

Please feel free to raise an [issue on GitHub](https://github.com/Open-CMSIS-Pack/STM32WB0x_DFP/issues)
